...
/**
  ...
  */
object MessageDbFactory extends FromValidatedRowModelFactory[StoredMessage] with FromTimelineRowFactory[StoredMessage]
{
	// COMPUTED	--------------------
	...
	override protected def fromValidatedModel(valid: Model) = 
		StoredMessage(valid(this.model.id.name).getInt, MessageData(valid(this.model.threadId.name).getInt,
